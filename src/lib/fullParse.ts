 ...
 * @param locale - The locale for parsing (e.g., 'de').
 * @returns A `Screenplay` object.
 */
function fullParse(locale: string = 'de'): Screenplay {
...
export type { Screenplay, Scene, Event, Action, Dialogue, Chapter, Song };
